...
#include "ImgProcess_kinect2.h"
#include "CameraCalibration.h"
ImgProcess_kinect2::ImgProcess_kinect2()
{
}
...
HRESULT ImgProcess_kinect2::init_kinect() {
	// 查找当前默认Kinect
...
Camera_Intrinsics ImgProcess_kinect2::getCameIns(ICoordinateMapper* pCoordinateMapper) {
...
bool ImgProcess_kinect2::getHDImage(string str) {
	int t1 = 0;
	char key = 0;
	bool loop = true;
